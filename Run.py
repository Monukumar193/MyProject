...
def process():
        ...
        #------------------------------Alert function----------------------------------#
                if (mask < withoutMask) or abnormal!=""  :
                        config.ALERT=True
                        ...
                        if config.ALERT:
                                ...
                                headers = {'authorization':"ZL3yoP7eYzsOaG0lCuQjh2Bknq8NwWFbdxVS4A1r9T6IKEJMftpVPEJ5K6DyhU02SkmHrLIzofa4seCT",'Content-Type': "application/x-www-form-urlencoded",'Cache-Control': "no-cache",}
